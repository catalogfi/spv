...
contract VerifySPVTest is Test {
    ...
    //     vm.expectRevert(
    //         "VerifySPV: invalid epoch, should contain previous 72 blocks and next 3 blocks"
    //     );
    //     verifySPV.registerBlock(epoch);
    // }
    ...
    //         epoch[counter] = difficultyEpoch[counter];
    //         if (counter < 73)
    //             epochForTxVerification[counter] = difficultyEpoch[counter];
    //         counter++;
    //     }
    ...
    //     proof[0] = bytes32(
    //         0x1a62992f9e3d1dcb699845cbee5d23569a13981ffbfd2c7c518be65821eaef06
    //     );
    //     proof[1] = bytes32(
    //         0x0c7652d6747faf960a42ed0345112140ad26a5d9cb7f0955b6ddd5c70d8ae6f5
    //     );
    //     proof[2] = bytes32(
    //         0xc7ba8b5b36d6eec2f350d0c72af6f1280e7fc05e767b5ac05d2bc606daebf065
    //     );
    //     proof[3] = bytes32(
    //         0x2bb7498551304f67657656fabfc66f92e60775040775f93d616c91e9cbfcb1c4
    //     );
    //     proof[4] = bytes32(
    //         0xaac8a3c0eac8f5a9eb25451a56bbf6134f4719c99460a7d892a4790fbc56d69f
    //     );
    //     proof[5] = bytes32(
    //         0xda071e5e721ac7a6eda6002feba70bf26700d3f39919b2dc5cf927a514b46fed
    //     );
    //     proof[6] = bytes32(
    //         0x50f4afabbecb0d3cfdcb2d19170a198662b78f00b9899ceaf5b270de0c52b4da
    //     );
    //     proof[7] = bytes32(
    //         0x75b5fc80d4bb258ef53691ad6eac624f6e274e85eec00f02aecf01bcf0947382
    //     );
    //     proof[8] = bytes32(
    //         0x257cd93d8ac8a403e09290c8236bfe951bb6d5944799b141b095258f4e71a3ab
    //     );
    //     proof[9] = bytes32(
    //         0x8a3c6629f70a22d0dff99e6feff7516d729baf4bb52583673685e655aa80cf4c
    //     );
    //     proof[10] = bytes32(
    //         0x5f372e5db7d25a390f2cb62243acbe107023c262b13db2f329c6a6780e4ab3b4
    //     );
    //     proof[11] = bytes32(
    //         0x5a3721a753244c9c41f44e4a41424f05dd8be93b97c518eb5f5286bc7ade3c7a
    //     );
    ...
    //     vm.expectRevert(
    //         "VerifySPV: inclusion verification needs all 72 blocks in the epoch"
    //     );
    ...
    //         epoch[counter] = difficultyEpoch[counter];
    //         if (counter < 73)
    //             epochForTxVerification[counter] = difficultyEpoch[counter + 1];
    //         counter++;
    //     }
    ...
    //             epoch[2].previousBlockHash = epoch[3].previousBlockHash;
    //             vm.expectRevert(
    //                 "VerifySPV: pre subsequence in difficulty epoch failed"
    //             );
    //             verifySPV.registerBlock(epoch);
    //         } else {
    //             verifySPV.registerBlock(epoch);
    ...
    //         if (i == 27) {
    //             epoch[72].previousBlockHash = difficultyEpoch[0]
    //                 .previousBlockHash;
    //             vm.expectRevert(
